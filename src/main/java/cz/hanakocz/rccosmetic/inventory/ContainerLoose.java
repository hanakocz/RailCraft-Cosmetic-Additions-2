...
public class ContainerLoose extends RailcraftContainer
{
    private final int numRows;
    
	public ContainerLoose(InventoryPlayer playerInventory, EntityCartOpen cart)
    {
        ...
        for (int j = 0; j < this.numRows; ++j)
        {
            for (int k = 0; k < 9; ++k)
            {
                this.addSlotToContainer(new SlotLoose(cart, k + j * 9, 8 + k * 18, 18 + j * 18));
            }
        }
